    ...
    render() {
        return (
            <div className="Clients">
                ...
                <p>
                    I've been working in Fiverr as a Freelancer, making Minecraft Plugins, since January 2023. Here are some reviews about me.
                </p>
                <div className="container" id="clientsScroll">
                    {
                            ...
                            return (
                                <div key={client.id} className="client">
                                    <div className="info">
                                        ...
                                        <div className="data">
                                            <p>{client.username} <span className="country">({client.reviewer_country})</span></p>
                                            <div className="stars">
                                            {
                                                [...Array(5)].map((x, i) => {
                                                    return (
                                                        <Icon 
                                                            className={client.value > i ? "star gold" : "star"} 
                                                            key={i} 
                                    ...
                                    <div className="description">
                                            <span className="descInfo">Lang: {client.comment_language} Date: {client.created_at.split("T")[0]}</span><br/>
                                            {client.comment}
                                    </div>
                                </div>
                            )
